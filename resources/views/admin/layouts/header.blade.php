...
<div class="header">
    ...
    <div class="header-logo">
        <a href="index.html">
            ...
            <img class="dark-logo" src="{{url('panel/assets/media/image/logo-dark.pngl')}}" alt="image">
        </a>
    </div>
    <!-- end::header logo -->
    <!-- begin::header body -->
        ...
        <div class="header-body-right">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                        <div class="p-4 text-center" data-backround-image="{{url('panel/assets/media/image/profile-bg.png')}}">
